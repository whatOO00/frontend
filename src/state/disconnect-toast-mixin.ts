        ...
        if (this.hass!.config.state === STATE_NOT_RUNNING) {
          showToast(this, {
            message:
              ...
              "Eko Energis EMS is starting. Not everything will be available until it is finished.",
            duration: -1,
            dismissable: false,
            action: {
              text:
          ...
          ({ showAlertDialog }) => {
            showAlertDialog(this, {
              ...
              text:
                ...
                "Eko Energis EMS is running in safe mode, custom integrations and community frontend modules are not available. Restart Eko Energis EMS to exit safe mode.",
            });
          }
        );
      }
