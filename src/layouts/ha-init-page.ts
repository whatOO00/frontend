...
class HaInitPage extends LitElement {
  ...
  protected render() {
    return this.error
      ? html`
          <p>Unable to connect to Eko Energis EMS.</p>
          <p class="retry-text">
          ...
          ${location.host.includes("ui.nabu.casa")
            ? html`
                <p>
                  ...
                  Eko Energis EMS is not currently connected. You can ask it to
      ...
      : html`
          ...
          <div id="loading-text">
            ${this.migration
              ? html`
                  Database upgrade is in progress, Eko Energis EMS will not start
